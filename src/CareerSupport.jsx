...
const questions = [
  {
    ...
    tone: "violet",
    options: [
      ["看護師", "/assets/career-support/q1-nurse.jpg"],
      ["准看護師", "/assets/career-support/q1-assistant-nurse.jpg"],
      ["保健師", "/assets/career-support/q1-public-health-nurse.jpg"],
      ["ケアマネージャー", "/assets/career-support/q1-care-manager.jpg"],
      ["その他", "/assets/career-support/q1-other.jpg"],
      ["無資格", "/assets/career-support/q1-no-license.jpg"],
    ],
  },
  {
    ...
    tone: "coral",
    options: [
      ["常勤（夜勤含む）", "/assets/career-support/q2-fulltime-night.jpg"],
      ["常勤（日勤のみ）", "/assets/career-support/q2-fulltime-day.jpg"],
      ["非常勤（扶養内）", "/assets/career-support/q2-parttime-dependent.jpg"],
      ["非常勤（扶養外）", "/assets/career-support/q2-parttime-independent.jpg"],
      ["こだわらない", "/assets/career-support/q2-flexible.jpg"],
    ],
  },
  {
    title: "いつ頃の転職をご希望ですか？",
    tone: "lilac",
    options: [
      ["1ヶ月以内", "/assets/career-support/q3-one-month.jpg"],
      ["3ヶ月以内", "/assets/career-support/q3-three-months.jpg"],
      ["6ヶ月以内", "/assets/career-support/q3-six-months.jpg"],
      ["6ヶ月より先", "/assets/career-support/q3-later.jpg"],
      ["良い求人があればいつでも", "/assets/career-support/q3-anytime.jpg"],
    ],
  },
];
